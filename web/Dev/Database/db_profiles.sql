...
--
-- Host: 127.0.0.1
-- Generation Time: Dic 17, 2014 alle 20:08
...
INSERT INTO `docenti` (`id`, `nome`, `cognome`, `dipartimento`, `ruolo`, `id_pagina_insegnamenti`, `nome_foto_profilo`, `sesso`) VALUES
(1, 'Fausto', 'Fasano', 'Bioscienze e Territorio', 'Ricercatore', 'fausto.fasano', 'wedding.jpg', 'M'),
(2, 'Rocco', 'Oliveto', 'Bioscienze e Territorio', 'Ricercatore', 'rocco.oliveto', 'Rocco.png', 'M'),
(3, 'Ciro', 'Marmolino', 'Bioscienze e Territorio', 'Professore associato', 'ciro.marmolino', NULL, 'M'),
(4, 'Barbara', 'Troncarelli', 'Bioscienze e Territorio', 'Professore associato', NULL, NULL, 'F'),
(5, 'Giuseppe', 'Lustrato', 'Bioscienze e Territorio', 'Ricercatore a tempo determinato', 'g.lustrato', NULL, 'M');
