...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2015 alle 20:34
...
INSERT INTO `amministratori` (`id`, `nome`, `password`) VALUES
(1, 'faufas', 'admin');
...
INSERT INTO `docenti` (`id`, `nome`, `cognome`, `dipartimento`, `id_ruolo`, `id_pagina_insegnamenti`, `nome_foto_profilo`, `sesso`, `password`) VALUES
(1, 'Fausto', 'Fasano', 'Bioscienze e Territorio', 0, 'fausto.fasano', 'wedding.jpg', 'M', 'pass'),
(2, 'Rocco', 'Oliveto', 'Bioscienze e Territorio', 0, 'rocco.oliveto', 'Rocco.png', 'M', 'pass'),
(3, 'Ciro', 'Marmolino', 'Bioscienze e Territorio', 1, 'ciro.marmolino', NULL, 'M', 'pass'),
(4, 'Barbara', 'Troncarelli', 'Bioscienze e Territorio', 1, NULL, NULL, 'F', 'pass'),
(5, 'Giuseppe', 'Lustrato', 'Bioscienze e Territorio', 2, 'g.lustrato', NULL, 'M', 'pass');
...
(1, 'Materiale di vitale importanza.rar', 'rar', 'Scarica il file "ciao mondo!!!"');
